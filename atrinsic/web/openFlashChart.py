...
def flashHTML(width, height, url, ofc_base_url="/ofc/", ofc_swf="open-flash-chart.swf" ):
	return (
		"""
		<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
			...
			<embed src="%(ofc_base_url)s%(ofc_swf)s" wmode="transparent" FlashVars="data-file=%(url)s" quality="high" bgcolor="#FFFFFF"
