...
(function($) {
	...
	_oExt.oJUIClasses = {
		/* Two buttons buttons */
		"sPagePrevEnabled": "customPrevPage",
		"sPagePrevDisabled": "customDisabledPrevPage",
		"sPageNextEnabled": "customNextPage",
		"sPageNextDisabled": "customDisabledNextPage",
		"sPageJUINext": "",
		"sPageJUIPrev": "",
	...
	_oExt.oPagination = {
	     ...
	     *           node:nPaging - the DIV which contains this pagination control
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				nFirst.innerHTML = '<div class="dtFirstBtn"></div>'//oSettings.oLanguage.oPaginate.sFirst;
				nPrevious.innerHTML = '<div class="dtPrevBtn"></div>'//oSettings.oLanguage.oPaginate.sPrevious;
				nNext.innerHTML = '<div class="dtNextBtn"></div>'//oSettings.oLanguage.oPaginate.sNext;
				nLast.innerHTML = '<div class="dtLastBtn"></div>'//oSettings.oLanguage.oPaginate.sLast;
				...
				$(nFirst).css("float","left")
				$(nPrevious).css("float","left")
				$(nNext).css("float","left")
				$(nLast).css("float","left")
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "<div class='dataTables_lengthShow'>Show</div> _MENU_ entries",
				"sZeroRecords": "No matching records found",
				"sInfo": "Showing _START_ to _END_ of _TOTAL_ entries",
				"sInfoEmpty": "Showing 0 to 0 of 0 entries",
				"sInfoFiltered": "(filtered from _MAX_ total entries)",
				"sInfoPostFix": "",
				"sSearch": "<div class='dataTables_filterSearch'>Search:</div>",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "First",
					"sPrevious": "Previous",
		...
		function _fnAddOptionsHtml ( oSettings )
		{
			...
			// Removed class ui-helper-clearfix from end. Caused display issue within IE. - Matt Sartain
			var sDom = oSettings.sDom.replace( "H", "fg-toolbar ui-widget-header ui-corner-tl ui-corner-tr" );
